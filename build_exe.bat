...
echo ============================================================
echo Building Mekong Salinity Demo EXE with SHAP support ^(recommended onedir mode^)
echo ============================================================
...
if exist dist\MekongSalinityDemo rmdir /s /q dist\MekongSalinityDemo
...
echo Build complete.
echo Run this file:
echo dist\MekongSalinityDemo\MekongSalinityDemo.exe
echo.
echo Keep the whole dist\MekongSalinityDemo folder together when moving it.
pause
